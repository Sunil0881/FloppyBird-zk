...
(function(e2) {
  (function() {
    ...
    h5 ? n5 = On : o5 && (n5 = self);
    var p5 = !n5.JS_SHA3_NO_COMMON_JS && true && e2.exports, b5 = !n5.JS_SHA3_NO_ARRAY_BUFFER && typeof ArrayBuffer < "u", m4 = "0123456789abcdef".split(""), w5 = [31, 7936, 2031616, 520093696], y8 = [4, 1024, 262144, 67108864], S5 = [1, 256, 65536, 16777216], I3 = [6, 1536, 393216, 100663296], N3 = [0, 8, 16, 24], C5 = [1, 0, 32898, 0, 32906, 2147483648, 2147516416, 2147483648, 32907, 0, 2147483649, 0, 2147516545, 2147483648, 32777, 2147483648, 138, 0, 136, 0, 2147516425, 0, 2147483658, 0, 2147516555, 0, 139, 2147483648, 32905, 2147483648, 32771, 2147483648, 32770, 2147483648, 128, 2147483648, 32778, 0, 2147483658, 2147483648, 2147516545, 2147483648, 32896, 2147483648, 2147483649, 0, 2147516424, 2147483648], F = [224, 256, 384, 512], U4 = [128, 256], J2 = ["hex", "buffer", "arrayBuffer", "array", "digest"], Bt3 = { 128: 168, 256: 136 };
    ...
    s3.prototype.update = function(u4) {
      ...
      for (var B3 = this.blocks, R2 = this.byteCount, T4 = u4.length, P2 = this.blockCount, O5 = 0, Ct4 = this.s, D4, q3; O5 < T4; ) {
        ...
        if (E7) for (D4 = this.start; O5 < T4 && D4 < R2; ++O5) B3[D4 >> 2] |= u4[O5] << N3[D4++ & 3];
        else for (D4 = this.start; O5 < T4 && D4 < R2; ++O5) q3 = u4.charCodeAt(O5), q3 < 128 ? B3[D4 >> 2] |= q3 << N3[D4++ & 3] : q3 < 2048 ? (B3[D4 >> 2] |= (192 | q3 >> 6) << N3[D4++ & 3], B3[D4 >> 2] |= (128 | q3 & 63) << N3[D4++ & 3]) : q3 < 55296 || q3 >= 57344 ? (B3[D4 >> 2] |= (224 | q3 >> 12) << N3[D4++ & 3], B3[D4 >> 2] |= (128 | q3 >> 6 & 63) << N3[D4++ & 3], B3[D4 >> 2] |= (128 | q3 & 63) << N3[D4++ & 3]) : (q3 = 65536 + ((q3 & 1023) << 10 | u4.charCodeAt(++O5) & 1023), B3[D4 >> 2] |= (240 | q3 >> 18) << N3[D4++ & 3], B3[D4 >> 2] |= (128 | q3 >> 12 & 63) << N3[D4++ & 3], B3[D4 >> 2] |= (128 | q3 >> 6 & 63) << N3[D4++ & 3], B3[D4 >> 2] |= (128 | q3 & 63) << N3[D4++ & 3]);
...
function q0(e2) {
  ...
  const y8 = 31, S5 = Math.pow(2, y8), I3 = S5 >>> 1, N3 = I3 >> 1, C5 = S5 - 1;
  let F = 0;
  ...
  for (; ; ) {
    ...
    for (; W2 & ~Rt2 & N3; ) F = F & I3 | F << 1 & C5 >>> 1 | w5(), W2 = W2 << 1 ^ I3, Rt2 = (Rt2 ^ I3) << 1 | I3 | 1;
    J2 = W2, Bt3 = 1 + Rt2 - W2;
  }
  let G = i4 - 4;
  return U4.map((H) => {
...
ce.blockSize = 512, ce.outSize = 256, ce.hmacStrength = 192, ce.padLength = 64, ce.prototype._update = function(t, r3) {
  ...
  for (Ys(this.k.length === i4.length), n5 = 0; n5 < i4.length; n5++) {
    var I3 = Ws(S5, ta(m4), Xs(m4, w5, y8), this.k[n5], i4[n5]), N3 = ie($s(o5), Zs(o5, h5, p5));
    S5 = y8, y8 = w5, w5 = m4, m4 = ie(b5, I3), b5 = p5, p5 = h5, h5 = o5, o5 = ie(I3, N3);
  }
...
ne.blockSize = 1024, ne.outSize = 512, ne.hmacStrength = 192, ne.padLength = 128, ne.prototype._prepareBlock = function(t, r3) {
  ...
  var i4 = this.W, n5 = this.h[0], o5 = this.h[1], h5 = this.h[2], p5 = this.h[3], b5 = this.h[4], m4 = this.h[5], w5 = this.h[6], y8 = this.h[7], S5 = this.h[8], I3 = this.h[9], N3 = this.h[10], C5 = this.h[11], F = this.h[12], U4 = this.h[13], J2 = this.h[14], Bt3 = this.h[15];
  oa(this.k.length === i4.length);
  for (var G = 0; G < i4.length; G += 2) {
    var H = J2, z6 = Bt3, Pt2 = Aa(S5, I3), W2 = ba(S5, I3), Rt2 = la(S5, I3, N3, C5, F), Yt3 = da(S5, I3, N3, C5, F, U4), Y = this.k[G], Vt3 = this.k[G + 1], A4 = i4[G], f6 = i4[G + 1], a4 = ua(H, z6, Pt2, W2, Rt2, Yt3, Y, Vt3, A4, f6), c6 = ha(H, z6, Pt2, W2, Rt2, Yt3, Y, Vt3, A4, f6);
    H = ma(n5, o5), z6 = ga(n5, o5), Pt2 = pa(n5, o5, h5, p5, b5), W2 = va(n5, o5, h5, p5, b5, m4);
    var d4 = Ci(H, z6, Pt2, W2), g5 = Ri(H, z6, Pt2, W2);
    J2 = F, Bt3 = U4, F = N3, U4 = C5, N3 = S5, C5 = I3, S5 = Ci(w5, y8, a4, c6), I3 = Ri(y8, y8, a4, c6), w5 = b5, y8 = m4, b5 = h5, m4 = p5, h5 = n5, p5 = o5, n5 = Ci(a4, c6, d4, g5), o5 = Ri(a4, c6, d4, g5);
  }
  Be(this.h, 0, n5, o5), Be(this.h, 2, h5, p5), Be(this.h, 4, b5, m4), Be(this.h, 6, w5, y8), Be(this.h, 8, S5, I3), Be(this.h, 10, N3, C5), Be(this.h, 12, F, U4), Be(this.h, 14, J2, Bt3);
...
Xe.inherits(pe, _f), Sf.ripemd160 = pe, pe.blockSize = 512, pe.outSize = 160, pe.hmacStrength = 192, pe.padLength = 64, pe.prototype._update = function(t, r3) {
  for (var i4 = this.h[0], n5 = this.h[1], o5 = this.h[2], h5 = this.h[3], p5 = this.h[4], b5 = i4, m4 = n5, w5 = o5, y8 = h5, S5 = p5, I3 = 0; I3 < 80; I3++) {
    var N3 = Nf(Tr(If(i4, Bf(I3, n5, o5, h5), t[_a[I3] + r3], Na(I3)), Ca[I3]), p5);
    i4 = p5, p5 = h5, h5 = Tr(o5, 10), o5 = n5, n5 = N3, N3 = Nf(Tr(If(b5, Bf(79 - I3, m4, w5, y8), t[Ba[I3] + r3], Ia(I3)), Ra[I3]), S5), b5 = S5, S5 = y8, y8 = Tr(w5, 10), w5 = m4, m4 = N3;
  }
  N3 = xr(this.h[1], o5, y8), this.h[1] = xr(this.h[2], h5, S5), this.h[2] = xr(this.h[3], p5, b5), this.h[3] = xr(this.h[4], i4, m4), this.h[4] = xr(this.h[0], n5, w5), this.h[0] = N3;
...
var Jt = cr(function(e2, t) {
  ...
  function i4(b5, m4, w5) {
    ...
    y8.fill(0);
    for (var S5 = 1 << m4 + 1, I3 = b5.clone(), N3 = 0; N3 < y8.length; N3++) {
      var C5, F = I3.andln(S5 - 1);
      I3.isOdd() ? (F > (S5 >> 1) - 1 ? C5 = (S5 >> 1) - F : C5 = F, I3.isubn(C5)) : C5 = 0, y8[N3] = C5, I3.iushrn(1);
    }
    return y8;
  }
  r3.getNAF = i4;
  function n5(b5, m4) {
    ...
    for (var y8 = 0, S5 = 0, I3; b5.cmpn(-y8) > 0 || m4.cmpn(-S5) > 0; ) {
      var N3 = b5.andln(3) + y8 & 3, C5 = m4.andln(3) + S5 & 3;
      N3 === 3 && (N3 = -1), C5 === 3 && (C5 = -1);
      var F;
      N3 & 1 ? (I3 = b5.andln(7) + y8 & 7, (I3 === 3 || I3 === 5) && C5 === 2 ? F = -N3 : F = N3) : F = 0, w5[0].push(F);
      var U4;
      C5 & 1 ? (I3 = m4.andln(7) + S5 & 7, (I3 === 3 || I3 === 5) && N3 === 2 ? U4 = -C5 : U4 = C5) : U4 = 0, w5[1].push(U4), 2 * y8 === F + 1 && (y8 = 1 - y8), 2 * S5 === U4 + 1 && (S5 = 1 - S5), b5.iushrn(1), m4.iushrn(1);
    }
    return w5;
  }
  r3.getJSF = n5;
...
Ce.prototype.point = function() {
  ...
  for (w5 = n5 - 1; w5 >= 1; w5 -= 2) {
    var N3 = w5 - 1, C5 = w5;
    if (h5[N3] !== 1 || h5[C5] !== 1) {
      b5[N3] = Ur(i4[N3], h5[N3], this._bitLength), b5[C5] = Ur(i4[C5], h5[C5], this._bitLength), m4 = Math.max(b5[N3].length, m4), m4 = Math.max(b5[C5].length, m4);
      continue;
    }
    var F = [r3[N3], null, null, r3[C5]];
    r3[N3].y.cmp(r3[C5].y) === 0 ? (F[1] = r3[N3].add(r3[C5]), F[2] = r3[N3].toJ().mixedAdd(r3[C5].neg())) : r3[N3].y.cmp(r3[C5].y.redNeg()) === 0 ? (F[1] = r3[N3].toJ().mixedAdd(r3[C5]), F[2] = r3[N3].add(r3[C5].neg())) : (F[1] = r3[N3].toJ().mixedAdd(r3[C5]), F[2] = r3[N3].toJ().mixedAdd(r3[C5].neg()));
    var U4 = [-3, -1, -5, -7, 0, 7, 5, 1, 3], J2 = Ta(i4[N3], i4[C5]);
    for (m4 = Math.max(J2[0].length, m4), b5[N3] = new Array(m4), b5[C5] = new Array(m4), y8 = 0; y8 < m4; y8++) {
      var Bt3 = J2[0][y8] | 0, G = J2[1][y8] | 0;
      b5[N3][y8] = U4[(Bt3 + 1) * 3 + (G + 1)], b5[C5][y8] = 0, p5[N3] = F;
    }
  }
...
Zt.prototype._getEndomorphism = function(t) {
  ...
  for (var r3 = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i4 = t, n5 = this.n.clone(), o5 = new K(1), h5 = new K(0), p5 = new K(0), b5 = new K(1), m4, w5, y8, S5, I3, N3, C5, F = 0, U4, J2; i4.cmpn(0) !== 0; ) {
    var Bt3 = n5.div(i4);
  ...
  I3 = U4.neg(), N3 = J2;
  var H = y8.sqr().add(S5.sqr()), z6 = I3.sqr().add(N3.sqr());
  return z6.cmp(H) >= 0 && (I3 = m4, N3 = w5), y8.negative && (y8 = y8.neg(), S5 = S5.neg()), I3.negative && (I3 = I3.neg(), N3 = N3.neg()), [{ a: y8, b: S5 }, { a: I3, b: N3 }];
...
Di(Tt, Ze.BasePoint), Zt.prototype.jpoint = function(t, r3, i4) {
  ...
  var w5 = b5.redSqr(), y8 = w5.redMul(b5), S5 = n5.redMul(w5), I3 = m4.redSqr().redIAdd(y8).redISub(S5).redISub(S5), N3 = m4.redMul(S5.redISub(I3)).redISub(h5.redMul(y8)), C5 = this.z.redMul(t.z).redMul(b5);
  return this.curve.jpoint(I3, N3, C5);
  ...
  var m4 = p5.redSqr(), w5 = m4.redMul(p5), y8 = i4.redMul(m4), S5 = b5.redSqr().redIAdd(w5).redISub(y8).redISub(y8), I3 = b5.redMul(y8.redISub(S5)).redISub(o5.redMul(w5)), N3 = this.z.redMul(p5);
  return this.curve.jpoint(S5, I3, N3);
  ...
  for (r3 = 0; r3 < t; r3++) {
    var y8 = h5.redSqr(), S5 = w5.redSqr(), I3 = S5.redSqr(), N3 = y8.redAdd(y8).redIAdd(y8).redIAdd(n5.redMul(m4)), C5 = h5.redMul(S5), F = N3.redSqr().redISub(C5.redAdd(C5)), U4 = C5.redISub(F), J2 = N3.redMul(U4);
  ...
  if (this.zOne) {
    ...
    var y8 = this.x.redSqr(), S5 = this.y.redSqr(), I3 = S5.redSqr(), N3 = this.x.redAdd(S5).redSqr().redISub(y8).redISub(I3);
    N3 = N3.redIAdd(N3);
    var C5 = y8.redAdd(y8).redIAdd(y8), F = C5.redSqr(), U4 = I3.redIAdd(I3);
    U4 = U4.redIAdd(U4), U4 = U4.redIAdd(U4), t = F.redISub(N3).redISub(N3), r3 = C5.redMul(N3.redISub(t)).redISub(U4), i4 = this.y.redMul(this.z), i4 = i4.redIAdd(i4);
  }
  ...
  if (this.zOne) {
    ...
    var y8 = this.z.redSqr(), S5 = this.y.redSqr(), I3 = this.x.redMul(S5), N3 = this.x.redSub(y8).redMul(this.x.redAdd(y8));
    N3 = N3.redAdd(N3).redIAdd(N3);
    var C5 = I3.redIAdd(I3);
    C5 = C5.redIAdd(C5);
    var F = C5.redAdd(C5);
    t = N3.redSqr().redISub(F), i4 = this.y.redAdd(this.z).redSqr().redISub(S5).redISub(y8);
    var U4 = S5.redSqr();
    U4 = U4.redIAdd(U4), U4 = U4.redIAdd(U4), U4 = U4.redIAdd(U4), r3 = N3.redMul(C5.redISub(t)).redISub(U4);
  }
  return this.curve.jpoint(t, r3, i4);
  ...
  var N3 = b5.redMul(S5).redISub(I3), C5 = i4.redAdd(i4).redMul(n5);
  return this.curve.jpoint(y8, N3, C5);
  ...
  I3 = I3.redIAdd(I3), I3 = I3.redIAdd(I3), I3 = I3.redIAdd(I3);
  var N3 = this.z.redAdd(p5).redSqr().redISub(i4).redISub(b5);
  return this.curve.jpoint(S5, I3, N3);
...
$t.prototype.keyPair = function(t) {
  ...
  for (var o5 = this.n.byteLength(), h5 = r3.getPrivate().toArray("be", o5), p5 = t.toArray("be", o5), b5 = new Rf({ hash: this.hash, entropy: h5, nonce: p5, pers: n5.pers, persEnc: n5.persEnc || "utf8" }), m4 = this.n.sub(new K(1)), w5 = 0; ; w5++) {
    ...
    if (y8 = this._truncateToN(y8, true), !(y8.cmpn(1) <= 0 || y8.cmp(m4) >= 0)) {
      ...
      if (!S5.isInfinity()) {
        var I3 = S5.getX(), N3 = I3.umod(this.n);
        if (N3.cmpn(0) !== 0) {
          var C5 = y8.invm(this.n).mul(N3.mul(r3.getPrivate()).iadd(t));
          if (C5 = C5.umod(this.n), C5.cmpn(0) !== 0) {
            var F = (S5.getY().isOdd() ? 1 : 0) | (I3.cmp(N3) !== 0 ? 2 : 0);
            return n5.canonical && C5.cmp(this.nh) > 0 && (C5 = this.n.sub(C5), F ^= 1), new zr({ r: N3, s: C5, recoveryParam: F });
          }
        }
      }
    }
...
function Au(e2, t) {
  const r3 = cn.sharedKey(fromString(e2, zt), fromString(t, zt), true), i4 = new import_hkdf.HKDF(import_sha256.SHA256, r3).expand(Wi);
...
function wu(e2) {
  ...
  const r3 = typeof e2.senderPublicKey < "u" ? fromString(e2.senderPublicKey, zt) : void 0, i4 = typeof e2.iv < "u" ? fromString(e2.iv, zt) : (0, import_random.randomBytes)(Vi), n5 = new import_chacha20poly1305.ChaCha20Poly1305(fromString(e2.symKey, zt)).seal(i4, fromString(e2.message, Gr));
  return to({ type: t, sealed: n5, iv: i4, senderPublicKey: r3 });
}
function xu(e2) {
  const t = new import_chacha20poly1305.ChaCha20Poly1305(fromString(e2.symKey, zt)), { sealed: r3, iv: i4 } = Xi(e2.encoded), n5 = t.open(i4, r3);
  if (n5 === null) throw new Error("Failed to decrypt");
  return toString(n5, Gr);
}
function to(e2) {
  if (Mr(e2.type) === lr) {
...
function Xi(e2) {
  const t = fromString(e2, Jr), r3 = t.slice(vu, Zf), i4 = Zf;
  if (Mr(r3) === lr) {
...
function createStorage(options = {}) {
  ...
  const storage = {
    ...
    async clear(base, opts = {}) {
      base = normalizeBaseKey(base);
      await Promise.all(
        getMounts(base, false).map(async (m4) => {
          if (m4.driver.clear) {
...
function Hi2(o5, e2) {
  ...
  function g5(u4) {
    ...
    for (var x3 = (P2 - D4) * d4 + 1 >>> 0, w5 = new Uint8Array(x3); D4 !== P2; ) {
      for (var O5 = u4[D4], N3 = 0, _3 = x3 - 1; (O5 !== 0 || N3 < T4) && _3 !== -1; _3--, N3++) O5 += 256 * w5[_3] >>> 0, w5[_3] = O5 % a4 >>> 0, O5 = O5 / a4 >>> 0;
  ...
  function m4(u4) {
    ...
    if (u4[p5] !== " ") {
      ...
      for (var P2 = (u4.length - p5) * l5 + 1 >>> 0, x3 = new Uint8Array(P2); u4[p5]; ) {
        ...
        if (w5 === 255) return;
        for (var O5 = 0, N3 = P2 - 1; (w5 !== 0 || O5 < D4) && N3 !== -1; N3--, O5++) w5 += a4 * x3[N3] >>> 0, x3[N3] = w5 % 256 >>> 0, w5 = w5 / 256 >>> 0;
...
var ge2 = (o5, e2) => {
  ...
  return Ve(o5, r3, 0), Ve(t, r3, i4), r3.set(e2, s3), new or2(o5, t, e2, r3);
};
var or2 = class {
  constructor(e2, t, i4, s3) {
...
var Zt2 = class extends w2 {
  constructor(n5) {
    super(n5), this.name = Fe2, this.events = new import_events8.default(), this.initialized = false, this.requestQueue = { state: D2.idle, queue: [] }, this.sessionRequestQueue = { state: D2.idle, queue: [] }, this.requestQueueDelay = import_time5.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.init = async () => {
      ...
      const N3 = await this.sendRequest({ topic: c6, method: "wc_sessionPropose", params: m4, throwOnFailedPublish: true });
      return await this.setProposal(N3, y6({ id: N3 }, m4)), { uri: h5, approval: S5 };
    }, this.pair = async (t) => {
      await this.isInitialized();
      try {
      ...
      try {
        await Promise.all([this.sendRequest({ topic: w5, method: "wc_sessionAuthenticate", params: N3, expiry: t.expiry, throwOnFailedPublish: true, clientRpcId: K3 }), this.sendRequest({ topic: w5, method: "wc_sessionPropose", params: v5, expiry: f4.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: Q4 })]);
      } catch (T4) {
        throw this.events.off(v0("session_connect"), W2), this.events.off(v0("session_request", K3), ce2), T4;
      }
      return await this.setProposal(Q4, y6({ id: Q4 }, v5)), await this.setAuthRequest(K3, { request: M2(y6({}, N3), { verifyContext: {} }), pairingTopic: w5 }), { uri: m4, response: B3 };
      ...
      for (const w5 of s3) {
        if (!await ou({ cacao: w5, projectId: this.client.core.projectId })) {
          ...
          throw await this.sendError({ id: e2, topic: a4, error: N3, encodeOpts: c6 }), new Error(N3.message);
        }
        const { p: m4 } = w5, E7 = Qr(m4.resources), O5 = [fu(m4.iss)], S5 = Li(m4.iss);
        if (E7) {
          const N3 = du(E7), P2 = pu(E7);
          h5.push(...N3), O5.push(...P2);
        }
        for (const N3 of O5) p5.push(`${N3}:${S5}`);
      }
  ...
  (function() {
    ...
    var If2 = function h5(g5) {
      ...
      function Yf2() {
        ...
        n: for (; l5-- && P2 < I3; ) {
          ...
          for (var T4 = -1, y8 = n5[v5]; ++T4 < m4; ) {
            var N3 = _3[T4], $3 = N3.iteratee, dn2 = N3.type, sn2 = $3(y8);
            if (dn2 == Wa2) y8 = sn2;
            else if (!sn2) {
      ...
      function An(n5, t, e2, r3, s3, o5) {
        ...
        }) : ia2(n5) && n5.forEach(function(y8, N3) {
          f6.set(N3, An(y8, t, e2, N3, n5, o5));
        });
        var E7 = v5 ? l5 ? pi2 : li : l5 ? on2 : V4, T4 = _3 ? i4 : E7(n5);
        return mn(T4 || n5, function(y8, N3) {
          T4 && (N3 = y8, y8 = n5[N3]), se2(f6, N3, An(y8, t, e2, N3, n5, o5));
        }), f6;
      }
      function wc(n5) {
        var t = V4(n5);
      ...
      function Xe4(n5, t, e2, r3, s3, o5, f6, c6, l5, v5) {
        ...
        function y8() {
          for (var N3 = arguments.length, $3 = d4(N3), dn2 = N3; dn2--; ) $3[dn2] = arguments[dn2];
          if (I3) var sn2 = qt3(y8), gn = ff2($3, sn2);
          if (r3 && ($3 = gu2($3, r3, s3, I3)), o5 && ($3 = vu2($3, o5, f6, I3)), N3 -= gn, I3 && N3 < v5) {
            var J2 = tt2($3, sn2);
            return xu2(n5, t, Xe4, y8.placeholder, e2, $3, J2, c6, l5, v5 - N3);
          }
          var Tn2 = m4 ? e2 : this, Qn2 = P2 ? Tn2[n5] : n5;
          return N3 = $3.length, c6 ? $3 = _h($3, c6) : E7 && N3 > 1 && $3.reverse(), _3 && l5 < N3 && ($3.length = l5), this && this !== k3 && this instanceof y8 && (Qn2 = T4 || ce2(Qn2)), Qn2.apply(Tn2, $3);
        }
        return y8;
      }
      function Cu2(n5, t) {
        ...
        for (o5.set(n5, t), o5.set(t, n5); ++m4 < c6; ) {
          ...
          if (I3) {
            if (!Hr2(t, function(N3, $3) {
              if (!jt3(I3, $3) && (E7 === N3 || s3(E7, N3, e2, r3, o5))) return I3.push($3);
            })) {
              P2 = false;
              break;
            }
      ...
      function eh2(n5, t, e2, r3, s3, o5) {
        ...
        for (var y8 = f6; ++m4 < l5; ) {
          P2 = c6[m4];
          var N3 = n5[P2], $3 = t[P2];
          if (r3) var dn2 = f6 ? r3($3, N3, P2, t, n5, o5) : r3(N3, $3, P2, n5, t, o5);
          if (!(dn2 === i4 ? N3 === $3 || s3(N3, $3, e2, r3, o5) : dn2)) {
            T4 = false;
            break;
          }
...
`);
      ...
      function Wl(n5, t, e2, r3) {
        ...
        var s3 = n5.length;
        return e2 < 0 && (e2 = Q4(s3 + e2, 0)), or3(n5) ? e2 <= s3 && n5.indexOf(t, e2) > -1 : !!s3 && Tt3(n5, t, e2) > -1;
      }
      ...
      function Xl(n5) {
        if (n5 == null) return 0;
        if (an2(n5)) return or3(n5) ? Dt3(n5) : n5.length;
        var t = tn2(n5);
      ...
      function ta2(n5, t, e2) {
        ...
        function E7(J2) {
          return v5 = J2, c6 = le3(N3, t), _3 ? I3(J2) : f6;
        }
        function T4(J2) {
        ...
        function gn() {
          ...
          if (r3 = arguments, s3 = this, l5 = J2, Tn2) {
            ...
            if (m4) return hu(c6), c6 = le3(N3, t), I3(l5);
          }
          return c6 === i4 && (c6 = le3(N3, t)), f6;
        }
      ...
      function aa2(n5) {
        if (!n5) return [];
        if (an2(n5)) return or3(n5) ? On2(n5) : un2(n5);
...
`;
        n5.replace(P2, function(y8, N3, $3, dn2, sn2, gn) {
          return $3 || ($3 = dn2), m4 += n5.slice(v5, gn).replace(Co2, lf2), N3 && (c6 = true, m4 += `' +
__e(` + N3 + `) +
'`), sn2 && (l5 = true, m4 += `';
` + sn2 + `;
__p += '`), $3 && (m4 += `' +
...
`) + m4 + `return __p
      ...
      return a4.after = kl, a4.ary = Qu2, a4.assign = Fp, a4.assignIn = ca2, a4.assignInWith = fr2, a4.assignWith = Mp, a4.at = qp, a4.before = Vu2, a4.bind = Ii2, a4.bindAll = Yd, a4.bindKey = ku, a4.castArray = cp, a4.chain = Zu2, a4.chunk = wh, a4.compact = Ph, a4.concat = Ah, a4.cond = Zd, a4.conforms = Jd, a4.constant = bi2, a4.countBy = Rl, a4.create = Bp, a4.curry = ju2, a4.curryRight = na2, a4.debounce = ta2, a4.defaults = Gp, a4.defaultsDeep = zp, a4.defer = jl, a4.delay = np, a4.difference = Ch, a4.differenceBy = Ih, a4.differenceWith = xh, a4.drop = Eh, a4.dropRight = yh, a4.dropRightWhile = Sh, a4.dropWhile = Oh, a4.fill = Rh, a4.filter = Tl, a4.flatMap = Nl, a4.flatMapDeep = Hl, a4.flatMapDepth = $l, a4.flatten = Gu2, a4.flattenDeep = bh, a4.flattenDepth = Th, a4.flip = tp, a4.flow = Qd, a4.flowRight = Vd, a4.fromPairs = Lh, a4.functions = Vp, a4.functionsIn = kp, a4.groupBy = Ul, a4.initial = Nh, a4.intersection = Hh, a4.intersectionBy = $h, a4.intersectionWith = Uh, a4.invert = nd, a4.invertBy = td, a4.invokeMap = Fl, a4.iteratee = Ti2, a4.keyBy = Ml, a4.keys = V4, a4.keysIn = on2, a4.map = rr3, a4.mapKeys = rd, a4.mapValues = id, a4.matches = kd, a4.matchesProperty = jd, a4.memoize = sr3, a4.merge = sd, a4.mergeWith = ha2, a4.method = ng, a4.methodOf = tg, a4.mixin = Li2, a4.negate = ur3, a4.nthArg = rg, a4.omit = ud, a4.omitBy = ad, a4.once = ep, a4.orderBy = ql, a4.over = ig, a4.overArgs = rp, a4.overEvery = sg, a4.overSome = ug, a4.partial = xi2, a4.partialRight = ea2, a4.partition = Bl, a4.pick = od, a4.pickBy = la2, a4.property = wa2, a4.propertyOf = ag, a4.pull = qh, a4.pullAll = Ku, a4.pullAllBy = Bh, a4.pullAllWith = Gh, a4.pullAt = zh, a4.range = og, a4.rangeRight = fg, a4.rearg = ip, a4.reject = Kl, a4.remove = Kh, a4.rest = sp, a4.reverse = Ai2, a4.sampleSize = Zl, a4.set = cd, a4.setWith = hd, a4.shuffle = Jl, a4.slice = Yh, a4.sortBy = Vl, a4.sortedUniq = jh, a4.sortedUniqBy = nl, a4.split = Nd, a4.spread = up, a4.tail = tl, a4.take = el, a4.takeRight = rl, a4.takeRightWhile = il, a4.takeWhile = sl, a4.tap = Pl, a4.throttle = ap, a4.thru = er3, a4.toArray = aa2, a4.toPairs = pa2, a4.toPairsIn = da2, a4.toPath = dg, a4.toPlainObject = fa2, a4.transform = ld, a4.unary = op, a4.union = ul, a4.unionBy = al, a4.unionWith = ol, a4.uniq = fl, a4.uniqBy = cl, a4.uniqWith = hl, a4.unset = pd, a4.unzip = Ci2, a4.unzipWith = Yu2, a4.update = dd, a4.updateWith = gd, a4.values = Gt3, a4.valuesIn = vd, a4.without = ll, a4.words = _a2, a4.wrap = fp, a4.xor = pl, a4.xorBy = dl, a4.xorWith = gl, a4.zip = vl, a4.zipObject = _l, a4.zipObjectDeep = ml, a4.zipWith = wl, a4.entries = pa2, a4.entriesIn = da2, a4.extend = ca2, a4.extendWith = fr2, Li2(a4, a4), a4.add = vg, a4.attempt = ma2, a4.camelCase = Pd, a4.capitalize = ga2, a4.ceil = _g, a4.clamp = _d, a4.clone = hp, a4.cloneDeep = pp, a4.cloneDeepWith = dp, a4.cloneWith = lp, a4.conformsTo = gp, a4.deburr = va2, a4.defaultTo = Xd, a4.divide = mg, a4.endsWith = Ad, a4.eq = bn2, a4.escape = Cd, a4.escapeRegExp = Id, a4.every = bl, a4.find = Ll, a4.findIndex = qu, a4.findKey = Kp, a4.findLast = Dl, a4.findLastIndex = Bu2, a4.findLastKey = Yp, a4.floor = wg, a4.forEach = Ju2, a4.forEachRight = Xu2, a4.forIn = Zp, a4.forInRight = Jp, a4.forOwn = Xp, a4.forOwnRight = Qp, a4.get = Si2, a4.gt = vp, a4.gte = _p, a4.has = jp, a4.hasIn = Oi2, a4.head = zu, a4.identity = fn2, a4.includes = Wl, a4.indexOf = Dh, a4.inRange = md, a4.invoke = ed, a4.isArguments = Pt2, a4.isArray = O5, a4.isArrayBuffer = mp, a4.isArrayLike = an2, a4.isArrayLikeObject = Z2, a4.isBoolean = wp, a4.isBuffer = at2, a4.isDate = Pp, a4.isElement = Ap, a4.isEmpty = Cp, a4.isEqual = Ip, a4.isEqualWith = xp, a4.isError = Ei2, a4.isFinite = Ep, a4.isFunction = Jn2, a4.isInteger = ra2, a4.isLength = ar3, a4.isMap = ia2, a4.isMatch = yp, a4.isMatchWith = Sp, a4.isNaN = Op, a4.isNative = Rp, a4.isNil = Tp, a4.isNull = bp, a4.isNumber = sa2, a4.isObject = K3, a4.isObjectLike = Y, a4.isPlainObject = pe3, a4.isRegExp = yi2, a4.isSafeInteger = Lp, a4.isSet = ua2, a4.isString = or3, a4.isSymbol = pn, a4.isTypedArray = Bt3, a4.isUndefined = Dp, a4.isWeakMap = Np, a4.isWeakSet = Hp, a4.join = Wh, a4.kebabCase = xd, a4.last = In2, a4.lastIndexOf = Fh, a4.lowerCase = Ed, a4.lowerFirst = yd, a4.lt = $p, a4.lte = Up, a4.max = Pg, a4.maxBy = Ag, a4.mean = Cg, a4.meanBy = Ig, a4.min = xg, a4.minBy = Eg, a4.stubArray = Ni2, a4.stubFalse = Hi3, a4.stubObject = cg, a4.stubString = hg, a4.stubTrue = lg, a4.multiply = yg, a4.nth = Mh, a4.noConflict = eg, a4.noop = Di2, a4.now = ir3, a4.pad = Sd, a4.padEnd = Od, a4.padStart = Rd, a4.parseInt = bd, a4.random = wd, a4.reduce = Gl, a4.reduceRight = zl, a4.repeat = Td, a4.replace = Ld, a4.result = fd, a4.round = Sg, a4.runInContext = h5, a4.sample = Yl, a4.size = Xl, a4.snakeCase = Dd, a4.some = Ql, a4.sortedIndex = Zh, a4.sortedIndexBy = Jh, a4.sortedIndexOf = Xh, a4.sortedLastIndex = Qh, a4.sortedLastIndexBy = Vh, a4.sortedLastIndexOf = kh, a4.startCase = Hd, a4.startsWith = $d, a4.subtract = Og, a4.sum = Rg, a4.sumBy = bg, a4.template = Ud, a4.times = pg, a4.toFinite = Xn2, a4.toInteger = R2, a4.toLength = oa2, a4.toLower = Wd, a4.toNumber = xn2, a4.toSafeInteger = Wp, a4.toString = W2, a4.toUpper = Fd, a4.trim = Md, a4.trimEnd = qd, a4.trimStart = Bd, a4.truncate = Gd, a4.unescape = zd, a4.uniqueId = gg, a4.upperCase = Kd, a4.upperFirst = Ri2, a4.each = Ju2, a4.eachRight = Xu2, a4.first = zu, Li2(a4, function() {
        ...
        s3 && (a4.prototype[t] = function() {
          var f6 = this.__wrapped__, c6 = r3 ? [1] : arguments, l5 = f6 instanceof H, v5 = c6[0], _3 = l5 || O5(f6), m4 = function(N3) {
            var $3 = s3.apply(a4, nt2([N3], c6));
            return r3 && P2 ? $3[0] : $3;
          };
...
var C4 = class _C {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m3(this.rpc.chains) : m3(this.rpc.optionalChains), this.signer = await hv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s3;
      try {
        const { WalletConnectModal: i4 } = await import("./dist-7XX77EEC.js");
        s3 = i4;
      } catch {
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-T4OHZ77L.js.map
